...
export const certifications = [
  {
    id: "aws-sa",
    name: "AWS Certified Solutions Architect – Associate 🙂(Click)👇",
  ...
  {
    id: "aws-sec",
    name: "AWS Certified Security – Specialty 🙂(Click)👇",
    issuer: "Amazon Web Services",
  ...
  {
    id: "ccna",
    name: "Cisco Certified Network Associate (CCNA) 🙂(Click)👇",
    issuer: "Cisco",
